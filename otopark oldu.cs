...
namespace OtoparkUcretiHesaplama
{
    class Program
    {
        ...
        {
            Console.WriteLine("Otoparka gelen aracın türünü girin (1: Otomobil, 2: Kamyon, 3: İş Makinası):");
            int aracTuru = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Otoparka gelen aracın kalma süresini girin (saat cinsinden):");
            ...
            Console.WriteLine("Çıkış ücreti: " + toplamUcret + " TL.");
